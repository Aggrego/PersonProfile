...
#    When create "person.relationship.family.command_build" profile with key
#      | key                  | value                                |
#      | superior_person_uuid | 0d2074fe-1144-4337-84d6-4832d1878f5d |
#      | child_person_uuid    | b0d6d1bb-061f-4ec0-927e-cc5095d3a122 |
#      | type                 | mother                               |
#    Then should exist "person.relationship.family.initial" fragmented data board
...
#    Then should exist "person.relationship.family.final" data board
